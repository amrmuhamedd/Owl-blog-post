...
import comment1 from "@images/blog/comment-1-1.png";
import comment2 from "@images/blog/comment-1-1.png";
      ...
      <div className="comment-one">
        ...
        <div className="comment-one__single">
          <div className="comment-one__image">
            <img src={comment1} alt="" style={{maxWidth : 90}}/>
          </div>
        ...
        <div className="comment-one__single">
          <div className="comment-one__image">
            <img src={comment2} alt="" style={{maxWidth : 90}}/>
          </div>
          <div className="comment-one__content">
            <h3>Nellie Hanson</h3>
            <p className="comment-one__date">
